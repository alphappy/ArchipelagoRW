...
# There should be a <ROOT_FP>/DLCSTATE/world folder for each DLCSTATE (right now, just "Vanilla" and "MSC").
# To construct this:
...
########################################################################################################################
                    ...
                    # There can be (and often are) multiple connections, and there may not be a third part (room tags).
                    match parts:
